...
export class HeaderComponent implements OnInit {
  ...
  // LEFT AND RIGHT ICON.
  icons = {has_left_icon:true, has_right_icon:true, left_icon:"assets/icon/settings/back.svg", right_icon:"assets/icon/Language.svg"};
  ...
  ngOnInit() {
    ...
    console.log("%cHeader caller %s", css, this.caller);
